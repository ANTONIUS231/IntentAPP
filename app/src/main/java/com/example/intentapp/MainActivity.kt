    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btn_move_activity_data -> {
                ...
                moveIntentWithData.putExtra(MoveActivityWithData.YOUR_NAME, "Antonius Simanjuntak")
                ...
                moveIntentWithData.putExtra(MoveActivityWithData.YOUR_NIM, 312010004)
                moveIntentWithData.putExtra(
                    MoveActivityWithData.YOUR_ADDRESS,
                    "Perumahan Grand Cikarang City Blok F21/06"
                )
                ...
                R.id.btn_move_activity_with_object -> {
                    val objectmhs = Mahasiswa(
                        ...
                        "312010004",
                        "23",
                        "antonius@mhs.pelitabangsa.ac.id",
                        "Bekasi"
                    )
